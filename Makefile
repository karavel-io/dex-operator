...
# quay.io/karavel/dex-operator-bundle:$VERSION and quay.io/karavel/dex-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/karavel/dex-operator
...
test: manifests generate fmt vet ## Run tests.
	...
	chmod +x ${ENVTEST_ASSETS_DIR}/setup-envtest.sh
